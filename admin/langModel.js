...
var commands = {
    ...
    'functionOnOff': {
        ...
        words: {
            ...
            'ru': "ключи/включи/включить/выключи/выключить/потушить/потуши/зажги/зажечь/процентов"
        },
        args: [{
            name: {
    ...
    'blindsUpDown': {
        ...
        words: {
            ...
            'ru': "ставни/окно/окна/жалюзи поднять/подними/опустить/опусти/открой/открою/открыть/закрыть/закрою/закрой/процентов"
        },
        ack: {
            type: 'checkbox',
            name: {
