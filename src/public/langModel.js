...
const commands = {
    ...
    userQuery: {
        ...
        args: [
            ...
            {
                name: {
                    "en": "Convert 0/1 to false/true",
                    "de": "Konvertieren Sie 0/1 in false/true",
                    "ru": "Конвертировать 0/1 в false/true",
                    "pt": "Converter 0/1 em falso/verdadeiro",
                    "nl": "Zet 0/1 om in false/true",
                    "fr": "Convertir 0/1 en faux/vrai",
                    "it": "Converti 0/1 in falso/vero",
                    "es": "Convertir 0/1 a falso/verdadero",
                    "pl": "Konwertuj 0/1 na false/true",
                    "zh-cn": "将0/1转换为false/true"
                },
                default: false,
                type: 'checkbox',
            },
