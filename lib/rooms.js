...
const rooms = {
    ...
    'guestwc/gästewc/гостевойтуалет': {
        ru: 'гостевой туалет/гостевом туалет',
        de: 'gäste wc',
        en: 'guets wc/guest closet',
    },
    'wc/туалет': { ru: 'туалет', de: 'wc', en: 'wc/closet' },
    'floor/diele/gang/flur/коридор/прихожая': {
        ru: 'прихож/вход/коридор',
        de: 'diele/eingang/flur',
        en: 'floor/enter',
    },
    'kitchen/küche/kueche/кухня': { ru: 'кухня/кухне', de: 'küche', en: 'kitchen' },
    'terrace/balkon/terrasse/терраса/балкон': {
        ru: 'балкон/террас',
        de: 'balkon/terrasse',
        en: 'balcony/terrace/patio',
    },
